...
public class BorrarIncidente {
	IProcesarRespuestaREST iProcesarRespuesta;
	 public BufferedReader realizarPeticion(JSONHandler json){
	        try{
	        	WSConector ws = new WSConector("DELETE",ParserXMLWSConnector.getInstance().getUrl()+"/"+json.getJsonRestIncidentesDelete().getId_rightnow(),"application/json");
